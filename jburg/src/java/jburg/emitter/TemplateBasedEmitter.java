...
public abstract class TemplateBasedEmitter implements EmitLang
{
     ...
     */
    protected String burmClassName;
        ...
        )
	{
        ...
        output.print(getTemplate("classHeader", "className", this.burmClassName, "baseClassName", baseClassName, "interfaceNames", interfaceNames ));

        // The entire class is too large to enclose in a block.
		output.print(getTemplate("beginEmitterBody", "reducerStack", reducerStack()));
	...
	@Override
	public void emitInclass(Vector<? extends Object> inclassBlocks, PrintStream output) 
	{
    ...
    public Object genCmpLess( Object lhs, Object rhs )
	{
        ...
        return getTemplate("greaterThan", "lhs", lhs, "rhs", rhs).toString();
	}

	@Override
    public Object genCmpGtEq(Object lhs, Object rhs)
	{
        return getTemplate("greaterThanOrEquals", "lhs", lhs, "rhs", rhs).toString();
	}
	@Override
    public Object genNot( Object operand )
	{
        return getTemplate("not", "operand", operand).toString();
	}
	...
	{
        return getTemplate("comment", "text", text).toString();
	}
    ...
    public Object genAddition( Object a1, Object a2 )
	{
		...
		if ( a2 == null || a2.equals("0") )
            ...
            return getTemplate("add", "lhs", a1, "rhs", a2).toString();
	}

	@Override
    public Object genAssignment( Object lvar, Object rvalue )
	{
        return getTemplate("assign", "lvar", lvar, "rvalue", rvalue).toString();
	}

	@Override
    public Object genCast(Object newClass, Object target)
	{
		return getTemplate("cast", "newClass", newClass, "target", target).toString();
	}
	...
	{
		return getTemplate("throwDiagnostic", "diagnostic", diagnostic).toString();
	}

	@Override
    public Object genReturnValue( Object value )
	{
		return getTemplate( "returnValue", "value", value).toString();
	}

    public Object genEndClass()
	{
		return getTemplate("endEmitterBody").toString();
	}
	...
	{
		return getTemplate("maxIntValue").toString();
	}
	...
	{
		return getTemplate("nullPointer").toString();
	}
	...
	{
        return getTemplate("declareContainer", "contentsType", contentsType).toString();
	}
    ...
    public Object genOverflowSafeAdd(Object expr1, Object expr2)
    {
		if ( expr1 == null || expr1.equals("0") )
            ...
            return getTemplate("normalizedAdd", "expr1", expr1, "expr2", expr2).toString();
    }
