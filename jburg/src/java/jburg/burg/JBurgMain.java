        ...
        try {
            ...
            if ( ! options.syntaxCheckOnly ) {
                ...
                try {
                    ...
                    String  className   = options.outputFile.substring(0, options.outputFile.lastIndexOf("."));
                    ...
                    generator.emit(className, new PrintStream(new FileOutputStream(outputPath)));
