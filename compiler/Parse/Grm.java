...
/** CUP v0.10k generated parser.
  * @version Fri Oct 18 10:22:30 IST 2019
  */
public class Grm extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\011\000\002\002\004\000\002\003\004\000\002\004" +
    "\004\000\002\004\002\000\002\006\004\000\002\006\002" +
    "\000\002\007\010\000\002\007\003\000\002\007\007" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\015\000\006\002\ufffc\056\ufffc\001\002\000\004\002" +
    "\017\001\002\000\006\002\ufffe\056\010\001\002\000\004" +
    "\002\000\001\002\000\006\002\ufffd\056\ufffd\001\002\000" +
    "\010\002\ufffa\004\011\056\ufffa\001\002\000\004\025\012" +
    "\001\002\000\004\036\013\001\002\000\004\051\014\001" +
    "\002\000\010\002\ufff9\004\015\056\ufff9\001\002\000\006" +
    "\002\ufffb\056\ufffb\001\002\000\004\002\uffff\001\002\000" +
    "\004\002\001\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\015\000\006\003\003\006\004\001\001\000\002\001" +
    "\001\000\006\004\005\007\006\001\001\000\004\005\015" +
  ...
  public final java_cup.runtime.Symbol CUP$Grm$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Grm$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // dec ::= TYPE ID EQ ARRAY OF 
            {
              Object RESULT = null;
		int v1left = ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-3)).left;
		int v1right = ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-3)).right;
		String v1 = (String)((java_cup.runtime.Symbol) CUP$Grm$stack.elementAt(CUP$Grm$top-3)).value;
		 System.out.println(">>>> type declaration " + v1); 
              CUP$Grm$result = new java_cup.runtime.Symbol(5/*dec*/, ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-4)).left, ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-0)).right, RESULT);
            }
		 ...
		 System.out.println(">>> type"); 
              CUP$Grm$result = new java_cup.runtime.Symbol(5/*dec*/, ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-0)).left, ((java_cup.runtime.Symbol)CUP$Grm$stack.elementAt(CUP$Grm$top-0)).right, RESULT);
            }
          return CUP$Grm$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // dec ::= TYPE ID EQ ARRAY OF ID 
            {
              Object RESULT = null;
		...
		Object s = (Object)((java_cup.runtime.Symbol) CUP$Grm$stack.elementAt(CUP$Grm$top-0)).value;
		 System.out.println(">>>> stmtlist"); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // program ::= declist stmtlist 
            {
              Object RESULT = null;
