...
public class Env {
    ...
    Env(ErrorMsg.ErrorMsg err) {
        ...
        venv.put(Symbol.symbol("print"), new FunEntry(new RECORD(Symbol.symbol("s"), Semant.STRING, null), null));
        venv.put(Symbol.symbol("flush"), new FunEntry(null, null));
        ...
        venv.put(Symbol.symbol("exit"), new FunEntry(new RECORD(Symbol.symbol("i"), Semant.INT, null), null));
